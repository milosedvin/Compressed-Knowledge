                    ...
                    <v-layout>
                        <v-row
                            ...
                            <v-img class="white--text align-end"
                                height="150px" v-bind:src="item.image">
                            </v-img>
                            ...
                            <v-card-text class="pa-3 mb-10" style="font-size:1em; font-weight: bold; color: black">
...
.buttonBPlus:hover, .buttonBMinus:hover{
  filter: brightness(105%);
}
.buttonBPlus::after, .buttonBMinus::after {
  content: " ";
  position: absolute;
  display: block;
